...
export const makeGroupData = (body : IGroup, ownerId : Types.ObjectId) : IGroup => {
...
export const createGroup = async (groupData : IGroup, userId: Types.ObjectId) : Promise<IGroupDocument> => {
...
export const getGroupPosts = async (groupId: string, userId: string) => {
