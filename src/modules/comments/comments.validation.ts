...
export const validationCommentContent = (req: Request, res: Response, next: NextFunction) => {
...
export const validationCommentParams = (req: Request, res: Response, next: NextFunction) => {
